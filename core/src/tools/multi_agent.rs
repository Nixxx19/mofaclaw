...
use crate::tools::{
    ...
    workflow::{GetWorkflowStatusTool, InitiateWorkflowTool, ListWorkflowsTool, StartWorkflowTool},
...
pub async fn register_multi_agent_tools(
    ...
    registry.register(InitiateWorkflowTool::new(
        workflow_engine.clone(),
        team_manager.clone(),
    ));
    ...
    registry.register(WaitForAgentResponseTool::new(team_manager.clone()));
}
